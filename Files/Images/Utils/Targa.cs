...
using Helper;
using static REFileKit.TargaImage;
...
namespace REFileKit
{
    ...
    internal class TargaImage : IDisposable
    {
        ...
        internal BitmapSource ToWPF()
        {
            ...
            var bmp = new WriteableBitmap(Header.Width, Header.Height, 96,96, System.Windows.Media.PixelFormats.Bgra32, Helper.WPF.Images.ConvertGDIPaletteToWPF(Palette));
