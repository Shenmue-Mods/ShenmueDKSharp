...
namespace ShenmueDKSharp.Files.Images._DDS
{
    public partial class DDSFormats
    {
        ...
        /// </summary>
        public class DDSFormatDetails
        {
            /// <summary>
            /// Length of header (DDS only)
            /// </summary>
            public int HeaderSize => (Format == DDSFormat.DDS_DX10 || (Format == DDSFormat.DDS_ARGB_32F && DX10Format == DDS_Header.DXGI_FORMAT.DXGI_FORMAT_R32G32B32A32_FLOAT)) ? DDS_DX10_HEADER_LENGTH : DDS_NO_DX10_HEADER_LENGTH;
            ...
            /// </summary>
            public bool IsPremultipliedFormat => Format == DDSFormat.DDS_DXT2 || Format == DDSFormat.DDS_DXT4;

            /// <summary>
            /// Number of bytes in color.
            /// </summary>
            ...
            /// <summary>
            /// Size of a discrete block in bytes. (e.g. 2 channel 8 bit color = 2, DXT1 = 16). Block can mean texel (DXTn) or pixel (uncompressed)
            /// </summary>
            ...
            /// </summary>
            public bool IsDDS => Format.ToString().Contains("DDS") || Format == DDSFormat.DDS_DX10;
            ...
            /// </summary>
            public Action<byte[], int, int, byte[], int, AlphaSettings, DDSFormatDetails> BlockEncoder = null;
            ...
            /// <summary>
            /// Writes a color from source to destination performing correct bit style conversions if requried.
            /// </summary>
            public Action<byte[], int, DDSFormatDetails, byte[], int> WriteColor = null;
